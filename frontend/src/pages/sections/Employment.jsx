  ...
  return (
    <div className="w-full max-w-screen-2xl mx-auto px-4 py-10">
      <div style={{ position: "relative", width: "100%" }}>
        <img
          src={slideImg}
          alt={language === "EN" ? "Employment and Unemployment" : "დასაქმება და უმუშევრობა"}
        ...
        <button
          ...
          onClick={() =>
            window.open(
              `/coverpdf/${language === "EN" ? "eng" : "geo"}/6.pdf`,
              "_blank",
            )
          }
        >
      ...
      >
        {language === "EN" ? "Employment and Unemployment" : "დასაქმება და უმუშევრობა"}
      </h2>
