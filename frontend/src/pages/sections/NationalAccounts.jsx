  ...
  return (
    <div className="w-full max-w-screen-2xl mx-auto px-4 py-10">
      <div style={{ position: "relative", width: "100%" }}>
        <img
          src={slideImg}
          alt={language === "EN" ? "GDP and National Accounts" : "ეროვნული ანგარიშები"}
        ...
        <button
          ...
          onClick={() =>
            window.open(
              `/coverpdf/${language === "EN" ? "eng" : "geo"}/10.pdf`,
              "_blank",
            )
          }
        >
      ...
      >
        {language === "EN" ? "GDP and National Accounts" : "ეროვნული ანგარიშები"}
      </h2>
